...
class FunraisinLeaderboard {
  ...
  constructor(target, base_url){
    ...
    if((this.element instanceof Element)){
      ...
      // add child
      this.element.innerHTML = '<div class="clb-result"></div><div class="clb-loader"><div class="bg-loader"><div></div><div></div><div></div><div></div></div></div>';
 ...
 */
  getLeaderboard(){
    ...
    const type    = this.element.getAttribute("clb-type")?this.element.getAttribute("clb-type"):"raised";
		...
		this.element.getAttribute("clb-loading","true");
